...
import { getTriCount } from '../utils/geometryUtils';
import { isTriDegenerate } from '../utils/triangleUtils';
...
export function performOperation(
	...
	// Addition always includes the second brush's outside-facing triangles.
